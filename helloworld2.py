...
# * Podem ser modificadsas depois de criadas
...
# * Como não podems ser modificadas ao decorrer do programa, elas são importante para ser usadas em dados que realmente são imutaveis. como um exemplo uma data de aniversãrio
...
# * Podems ser modificadas no decorrer do programa
#__________________________________________________________________________________